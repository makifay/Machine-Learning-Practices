% BLG527E, HW2, Q3, Quadratic Discriminant Analysis for normal data
% Akif Aydogmus, ID: 702121013
% run on Ubuntu 14.04.5 LTS, GNU Octave, version 3.8.1


function ret = hw2q3qda()
...
X_L0_data = importdata ("normalC0.txt");  % read input data
X_L1_data= importdata ("normalC1.txt");  % read input data
